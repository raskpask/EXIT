    ...
    renderInfo() {
        return (
            <ListGroup>
                ...
                <ListGroup.Item>{this.props.info.degreeProject.inProgess}: {this.props.project.in_progress ? this.props.info.general.no : this.props.info.general.yes }</ListGroup.Item>
            </ListGroup>
        )
    }
    renderCompany() {
